...
const COMPANY      = "NewCo";                // @init  company/service display name
...
const OPERATOR_EMAIL         = "new@co.com";    // @init  password-mode admin identity
const OPERATOR_NAME          = "NewCo";               // @init  operator display name
...
const APP_ACCENT        = "#0f9d6e";   // → ui.appAccent       (--brand / --ring)
const APP_ACCENT_BRIGHT = "#14b886";   // → ui.appAccentBright  (--brand-mint)
const APP_ACCENT_DEEP   = "#0a7d57";   // → ui.appAccentDeep    (--brand-deep / --rail)
